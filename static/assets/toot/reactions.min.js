 ...
 */};var l,o;class s extends u$1{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,e;const o=super.createRenderRoot();return null!==(t=(e=this.renderOptions).renderBefore)&&void 0!==t||(e.renderBefore=o.firstChild),o}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=D(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!1)}render(){return T}}s.finalized=!0,s._$litElement$=!0,null===(l=globalThis.litElementHydrateSupport)||void 0===l||l.call(globalThis,{LitElement:s});const n=globalThis.litElementPolyfillSupport;null==n||n({LitElement:s}),(null!==(o=globalThis.litElementVersions)&&void 0!==o?o:globalThis.litElementVersions=[]).push("3.3.2");const DEFAULT_EMOJIS="👍,thumbs-up;😄,smile-face;🎉,party-popper;😕,confused-face;❤️,red-heart;🚀,rocket;👀,eyes;👎,thumbs-down;";class EmojiReaction extends s{static properties={showAvailable:{attribute:!1},availableReactions:{attribute:!1},availableArrayString:{},endpoint:{},reactTargetId:{},theme:{}};static styles=i$1`
  ...
  `;render(){const t=window.matchMedia("(prefers-color-scheme: light)").matches?"light":"dark";return x`
    ...
    <!-- container -->
    <div style="display: flex; gap: 0.375rem; height: 1.5rem;" class="${"dark"===this?.theme||"system"===this?.theme&&"dark"===t?"container-dark":"container"}">
      <!-- 灰色笑脸 -->
    ...
    `}constructor(){super(),this.showAvailable=!1,this.availableReactions=[]}connectedCallback(){super.connectedCallback(),this.initReactions()}async initReactions(){let t=this?.availableArrayString;t||(t=DEFAULT_EMOJIS);const e=t.split(";").map((t=>{const[e,o]=t.split(",");return e&&o?{emoji:e,reaction_name:o}:null})).filter((t=>t));this?.endpoint||(this.endpoint="https://api.emaction.cool");let o="";const i=document.head.querySelector("link[rel='canonical']");o=i&&i.href?i.href:window.location.href;const r=new URL(o),a=r.origin+r.pathname+r.search;this?.reactTargetId||(this.reactTargetId=await this._sha256(a));const{data:{reactionsGot:s}}=await fetch(this.endpoint+"/reactions?"+new URLSearchParams({targetId:this.reactTargetId}),{method:"GET"}).then((t=>t.json())).then((t=>{if(!t?.data||!Array.isArray(t?.data?.reactionsGot))throw new Error("获取 reactions 出错！");return t}));s.forEach((t=>{e.forEach((e=>{t.reaction_name===e.reaction_name&&(e.count=t.count)}))}));const n=`meReactedReactions_${this.reactTargetId}`;JSON.parse(window.localStorage.getItem(n)||"[]").forEach((t=>{e.forEach((e=>{t===e.reaction_name&&(e.meReacted=!0)}))})),this.availableReactions=e}_closePopup(t){this.showAvailable=!1}async _react(t){const{name:e}=t.target.dataset,o=this.availableReactions.find((t=>t.reaction_name===e));if(!o)return;const i=!!o?.meReacted,r=Math.max(0,o?.count?o.count+(i?-1:1):i?0:1),a=!o.meReacted;this.availableReactions=this.availableReactions.map((t=>(t.reaction_name===e&&(t.count=r,t.meReacted=a),t))),this.showAvailable=!1,await fetch(this.endpoint+"/reaction?"+new URLSearchParams({targetId:this.reactTargetId,reaction_name:e,diff:i?-1:1}),{method:"PATCH"});const s=`meReactedReactions_${this.reactTargetId}`,n=new Set(JSON.parse(window.localStorage.getItem(s)||"[]"));i?n.delete(e):n.add(e),window.localStorage.setItem(s,JSON.stringify(Array.from(n)))}_showAvailable(t){t.preventDefault(),this.showAvailable=!this.showAvailable}async _sha256(t){return Array.from(new Uint8Array(await crypto.subtle.digest("sha-256",(new TextEncoder).encode(t)))).map((t=>t.toString(16).padStart(2,"0"))).join("")}}customElements.define("emoji-reaction",EmojiReaction);export{EmojiReaction};