...
> **重要更新**：本站已移除 `Umami` 统计系统，且未部署其他统计系统。

### 引言

欢迎您访问我们的产品。Eallion.com（包括网站等产品提供的服务，以下简称『产品和服务』）是由 eallion（_Charles Chin_）（以下简称『我』或者『我们』）开发并运营的。确保用户的数据安全和隐私保护是我们的首要任务，本隐私政策载明了您访问和使用我们的产品和服务时所收集的数据及其处理方式。
