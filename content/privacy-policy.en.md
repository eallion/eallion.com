...
* 位置信息
* 更多参考：[https://support.google.com/analytics/](https://support.google.com/analytics/)

* Disqus 评论系统基于您的**主动提交**会收集：

* 昵称
* 头像
* 不会收集~电子邮件地址 Email~
* 不会收集~网络身份标识信息（浏览器 UA、IP 地址）~
...
<table><thead><tr><th>类型</th><th>信息</th></tr></thead><tbody><tr><td>IP</td><td><p>119.100.148.18</p></td></tr><tr><td>UA</td><td><p>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Safari/537.36</p></td></tr></tbody></table>
