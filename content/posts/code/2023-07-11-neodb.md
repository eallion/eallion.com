...
在 Hugo 根目录或者主题目录 `layouts/_default` 新建一个 <i class="fab fa-github fa-fw"></i>[movie.html](https://github.com/eallion/eallion.com/blob/808fbad76ec314ac35f5e32c3d7b7d5c66c057ec/layouts/_default/movie.html) 模板。
...
下面是具体的 GitHub Actions <i class="fab fa-github fa-fw"></i>[neodb.yml](https://github.com/eallion/eallion.com/blob/808fbad76ec314ac35f5e32c3d7b7d5c66c057ec/.github/workflows/neodb.yml) 代码。不需要用到的步骤直接删除即可。
