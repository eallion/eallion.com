...
slug: wannacry
summary: WannaCry 勒索病毒暴露出高校和政府部门的安全意识薄弱，而 360 等安全软件未能有效防护。避免中招的关键在于：修改默认端口、升级系统、禁用第三方安全软件、开启自动更新、启用防火墙、使用
  Linux 系统、定期自动备份文件以及及时关闭高危端口。Win10 自带防护已足够，手动备份易疏漏，自动化备份能快速恢复数据。养成良好的安全习惯比依赖安全软件更可靠！
tags:
- 安全
- wannacry
- 勒索
