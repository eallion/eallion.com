...
slug: changlogs
summary: 经过多日纠结，最终决定采用多说评论系统并本地化 JS 代码，但因其 CSS 兼容性问题暂时回退。主页图片轮播插件不兼容 IE6 而采用降级方案，同时集成了友荐文章关联插件。博客还实现了每日一句功能，采用
  Slimbox2 图片特效和亦歌音乐播放器。技术栈包括 Typecho 程序、NeoWin 主题及多个自定义模块，整体兼顾功能与兼容性！
tags:
- 博客
- 小记
- 改动
