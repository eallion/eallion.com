...
* Mastodon：[https://e5n.cc/@eallion](https://e5n.cc/@eallion) (**👍Recommended**)
* OpenPGP(Keyoxide)：[`E685DDDDDDDDDDDD`](https://keyoxide.org/E685DDDDDDDDDDDD)

    ```bash
    curl -sL https://eallion.com/key | gpg --import -
    ```
